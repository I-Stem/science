...
* layout_PRIMA.py:  In case of fallback of poor performance from layout_inference we use Detectron2([click here for details](https://ai.facebook.com/blog/-detectron2-a-pytorch-based-modular-object-detection-library-/)).
