...
![The architecture of Faster R-CNN](../adding-model-architecture/model architecture/The-architecture-of-Faster-R-CNN.png)  
...
![The overall network architecture of Mask R-CNN](../adding-model-architecture/model architecture/The-overall-network-architecture-of-Mask-R-CNN.png)  
